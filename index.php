...
<head>
     ...
     <title>Aplikasi Data Perpustakaan</title>
</head>

<body style="background-color:#06b209">
     <!-- Navbar -->
     <nav class="navbar navbar-expand-lg navbar-blue bg-warning text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Data Perpustakaan</a>
     ...
     <div class="container-fluid">
          <div class="row bg-warning text-black text-center">
               <div class="col my-2" id="about">
                    <br>
                    <p>
                      Copyright 2025 -Bams ID
                    </p>
               </div>
          </div>
     </div>
